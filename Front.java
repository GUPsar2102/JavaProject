...
public class Front extends WindowAdapter implements ActionListener, ItemListener {
    ...
    Frame f = new Frame();
    Image icon_for_main_quiz = Toolkit.getDefaultToolkit().getImage("R:\\icon.jpg");
    ...
    /*Constructor*/
    public Front(String firstname, String lastname, String user_email) {
